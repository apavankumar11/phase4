...
public interface QuizMapper extends
	EntityDtoMapper<org.pavan.fsd.p4.api.dto.Quiz, org.pavan.fsd.p4.api.entity.Quiz> {

	@Mapping(source = "categoryId", target = "category")
	@Mapping(source = "userId", target = "tester")
	@Mapping(target = "image", ignore = true)
	org.pavan.fsd.p4.api.entity.Quiz toEntity(org.pavan.fsd.p4.api.dto.Quiz dto);
	
	@Mapping(source = "category", target = "categoryId")
	@Mapping(source = "tester", target = "userId")
	@Mapping(target = "image", ignore = true)
	org.pavan.fsd.p4.api.dto.Quiz toDto(org.pavan.fsd.p4.api.entity.Quiz entity);
