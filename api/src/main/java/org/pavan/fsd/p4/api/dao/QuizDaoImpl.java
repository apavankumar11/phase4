...
import org.pavan.fsd.p4.api.mapper.CategoryMapper;
import org.pavan.fsd.p4.api.mapper.QuizMapper;
import org.pavan.fsd.p4.api.mapper.UserMapper;
...
public class QuizDaoImpl implements QuizDao {
	...
	public Quiz save(Quiz quiz) throws OnlineTestDaoException {
		...
		try {
			org.pavan.fsd.p4.api.entity.Quiz entity = mapper.toEntity(quiz);
	...
	public byte[] getQuizImage(Long id) throws OnlineTestDaoException {
		...
		try {
			org.pavan.fsd.p4.api.entity.Quiz quiz = repository.findWithImageAttachedById(id);
			image = quiz.getImage();
		} catch (Exception e) {
			throw new OnlineTestDaoException(e.getMessage());
		}
